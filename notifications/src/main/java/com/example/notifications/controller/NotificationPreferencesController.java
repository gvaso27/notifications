...
public class NotificationPreferencesController {
    ...
    @DeleteMapping("/delete_preference/{preferenceId}")
    public ResponseEntity<String> deleteNotificationPreference(@PathVariable Long preferenceId) {
        notificationPreferencesService.removeNotificationPreference(preferenceId);
